...
export declare type InternalCoordinatesOptions<Key extends CoordinatesKey = CoordinatesKey> = InternalGestureOptions<Key> & {
    axis?: 'x' | 'y';
...
export declare type InternalPinchOptions = InternalGestureOptions<'pinch'> & {
    /**
